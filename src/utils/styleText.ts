...
export const styleText = [
    ...
    ".bbp.overlay>div.loading-box { width: 300px; height: 100px; background-color: #fff; border-radius: 10px; padding: 10px; box-shadow: 0 0 10px #0005; }",
    ".bbp.overlay>div.loading-box>h5.loading-message { color: #000; font-family: Verdana, sans-serif;}",
    ".bbp.overlay>div.loading-box>div.loading-progress-container { position: relative; margin: 10px; height: 20px; border-radius: 10px; background-color: #ddd; }",
    ".bbp.overlay>div.loading-box>div.loading-progress-container>div.loading-progress { position: absolute; top: 0; left: 0; bottom: 0; width: 0%; border-radius: 10px; background-color: #e95420; }",
    ...
    ".bbp.record-form>label { display: block; text-align: left; font-family: Verdana, sans-serif; }",
    ".bbp.record-form>input { width: 100%; margin-bottom: 15px; box-sizing: border-box; }",
    ".bbp.record-form>.publish-btn { border: none; font-weight: bold; background-color: #e95420; color: white; padding: 5px 10px; margin: 5px 0 2px 0; width: 100%; cursor: pointer; }",
    ".bbp.record-form>.publish-btn:hover { background-color: #ca491a }",
    ".bbp.record-form>.close-btn, .bbp.publish-form>.cancel-btn { border: none; font-weight: bold; background-color: white; padding: 5px 10px; margin: 5px 0 2px 0; width: 100%; cursor: pointer; }",
    ".bbp.record-form>.close-btn:hover, .bbp.publish-form>.cancel-btn:hover { background-color: #ddd }",
    ".bbp.record-form>p.form-info { font-size: 12pt; font-family: Verdana, sans-serif; }",
    ".bbp.record-form>small { font-size: 8pt; font-family: Verdana, sans-serif; text-align: left; }",
].join(" ");
